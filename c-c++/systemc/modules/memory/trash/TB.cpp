// #pragma once
// #include "MLP/SystemC/Cycle\ Accurate/Real/Memory/memory.hpp"  // your module header
...
//     std::vector<int> dumpTimes{10, 20, 30};
...
//         address.write(sc_lv<WIDTH>(std::string(WIDTH, '1'))); // max address (all ones)
//         read.write(SC_LOGIC_1);
//         write.write(SC_LOGIC_0);
//         wait(10, SC_NS);
...
//     SC_CTOR(MemoryTB)
//     {
//         mem = new Memory<T, WIDTH>("MemoryInstance", "memory_input.csv", "memory_dump.csv", dumpTimes);
...
// {
//     sc_report_personalized::set_report_handler("MLP/SystemC/Cycle\ Accurate/Real/Memory/memory.log");
//     MemoryTB tb("tb");
//     sc_start();
