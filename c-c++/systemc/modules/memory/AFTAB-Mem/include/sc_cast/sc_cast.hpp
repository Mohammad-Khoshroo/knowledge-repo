...
template <typename T>
inline std::string type_name(const T& var)
{
    int status;
...
namespace sc_cast
{
        ...
        sc_lv_cast(const LV& lv)
    {
        ...
        uint32_t raw = static_cast<uint32_t>(lv.to_uint64());
        float f;
